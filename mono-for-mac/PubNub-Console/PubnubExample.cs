        ...
        static public void Main ()
        {
            ...
            while (!exitFlag) {
                ...
                case "111":
                    ...
                    Console.WriteLine ("Running subscribe()");
					//pubnub.Subscribe<object> (channel, DisplaySubscribeReturnMessage, DisplaySubscribeConnectStatusMessage, DisplayErrorMessage);
					//pubnub2.Subscribe<string>(channel, DisplaySubscribeReturnMessage, DisplaySubscribeConnectStatusMessage, DisplayErrorMessage);
                    pubnub.Subscribe<object> (channel, (object o) => {
                        DisplayReturnMessage (o);
                    }, (object o) => {
                        DisplayReturnMessage (o);
                    }, DisplayErrorMessage);
                ...
                case "222":
                    ...
                    pubnub.Publish (channel, (object)message, DisplayReturnMessage, DisplayErrorMessage);
                    break;
                case "3":
                ...
                case "12":
                    ...
                    Console.WriteLine ("How many minutes do you want to allow Grant Access? Enter the number of minutes. (0 for forever)");
                ...
                case "15":
                    ...
                    Console.WriteLine ("How many minutes do you want to allow Grant Presence Access? Enter the number of minutes. (0 for forever)");
                    Console.WriteLine ("Default = 1440 minutes (24 hours). Press ENTER now to accept default value.");
