...
namespace PubNubMessaging.Core
{
	internal class PubnubWin : PubnubCore
	{
        ...
        protected override PubnubWebRequest SetProxy<T1, T2, T3, T4>(PubnubWebRequest request)
        {
        ...
        protected override PubnubWebRequest SetTimeout<T1, T2, T3, T4>(RequestState<T1, T2, T3, T4> pubnubRequestState, PubnubWebRequest request)
        {
#if (!SILVERLIGHT && !WINDOWS_PHONE && !NETFX_CORE)
        ...
        protected override sealed void SendRequestAndGetResult<T1, T2, T3, T4>(Uri requestUri, RequestState<T1, T2, T3, T4> pubnubRequestState, PubnubWebRequest request)
        {
#if (SILVERLIGHT || WINDOWS_PHONE || NETFX_CORE)
            ...
            IAsyncResult asyncResult = request.BeginGetResponse(new AsyncCallback(UrlProcessResponseCallback<T1, T2, T3, T4>), pubnubRequestState);
            Timer webRequestTimer = new Timer(OnPubnubWebRequestTimeout<T1, T2, T3, T4>, pubnubRequestState, GetTimeoutInSecondsForResponseType(pubnubRequestState.ResponseType) * 1000, Timeout.Infinite);
#else
            if (!ClientNetworkStatus.MachineSuspendMode && !PubnubWebRequest.MachineSuspendMode)
            {
                IAsyncResult asyncResult = request.BeginGetResponse(new AsyncCallback(UrlProcessResponseCallback<T1, T2, T3,T4>), pubnubRequestState);
                ThreadPool.RegisterWaitForSingleObject(asyncResult.AsyncWaitHandle, new WaitOrTimerCallback(OnPubnubWebRequestTimeout<T1, T2, T3, T4>), pubnubRequestState, GetTimeoutInSecondsForResponseType(pubnubRequestState.ResponseType) * 1000, true);
            }
            else
            {
                ...
                netState.Type = pubnubRequestState.ResponseType;
            ...
            if (pubnubRequestState.ResponseType == ResponseType.Presence || pubnubRequestState.ResponseType == ResponseType.Subscribe)
            {
                ...
                {
                    RequestState<T1, T2, T3, T4> presenceHeartbeatState = new RequestState<T1, T2, T3, T4>();
                    ...
                    {
                        presenceHeartbeatTimer = new Timer(OnPresenceHeartbeatIntervalTimeout<T1, T2, T3, T4>, presenceHeartbeatState, base.PresenceHeartbeatInterval * 1000, base.PresenceHeartbeatInterval * 1000);
                    }
                }
            }
        }

		protected override void TimerWhenOverrideTcpKeepAlive<T1, T2, T3, T4> (Uri requestUri, RequestState<T1, T2, T3, T4> pubnubRequestState)
		{
			if(localClientHeartBeatTimer != null){
				localClientHeartBeatTimer.Dispose();
			}
            localClientHeartBeatTimer = new Timer(new TimerCallback(OnPubnubLocalClientHeartBeatTimeoutCallback<T1, T2, T3, T4>), pubnubRequestState, 0,
        ...
        protected override void ProcessResponseCallbackExceptionHandler<T1, T2, T3, T4>(Exception ex, RequestState<T1, T2, T3, T4> asynchRequestState)
        {
            ...
            UrlRequestCommonExceptionHandler<T1, T2, T3, T4>(asynchRequestState.ResponseType, asynchRequestState.Channels, asynchRequestState.ChannelGroups, asynchRequestState.Timeout, asynchRequestState.SubscribeRegularCallback, asynchRequestState.PresenceRegularCallback, asynchRequestState.ConnectCallback, asynchRequestState.WildcardPresenceCallback, asynchRequestState.ErrorCallback, false);
        }

        protected override bool HandleWebException<T1, T2, T3, T4>(WebException webEx, RequestState<T1, T2, T3, T4> asynchRequestState, string channel, string channelGroup)
        {
        ...
        protected override void ProcessResponseCallbackWebExceptionHandler<T1, T2, T3, T4>(WebException webEx, RequestState<T1, T2, T3, T4> asyncRequestState, string channel, string channelGroup)
        {
            bool reconnect = false;
            ...
            //#elif (!SILVERLIGHT)
            reconnect = HandleWebException<T1, T2, T3, T4>(webEx, asyncRequestState, channel, channelGroup);

            UrlRequestCommonExceptionHandler<T1, T2, T3, T4>(asyncRequestState.ResponseType, asyncRequestState.Channels, asyncRequestState.ChannelGroups, asyncRequestState.Timeout,
        ...
        protected override void UrlProcessResponseCallback<T1, T2, T3, T4>(IAsyncResult asynchronousResult)
        {
            List<object> result = new List<object>();

            RequestState<T1, T2, T3, T4> asyncRequestState = asynchronousResult.AsyncState as RequestState<T1, T2, T3, T4>;
            ...
            try
            {
                    ...
                    using (PubnubWebResponse asyncWebResponse = (PubnubWebResponse)asyncWebRequest.EndGetResponse(asynchronousResult))
                    {
                        ...
                        using (StreamReader streamReader = new StreamReader(asyncWebResponse.GetResponseStream()))
                        {
                                                ...
                                                ))
                                {
                                    ...
                                    if (asyncRequestState.ChannelGroups != null && asyncRequestState.ChannelGroups.Length > 0)
                                    {
                                        for (int index = 0; index < asyncRequestState.ChannelGroups.Length; index++)
                                        {
                                            ...
                                            callbackKey.Type = asyncRequestState.ResponseType;
                            ...
                            else if (jsonString != "[]")
                            {
                                ...
                                {
                                    result = WrapResultBasedOnResponseType<T1, T2, T3, T4>(asyncRequestState.ResponseType, jsonString, asyncRequestState.Channels, asyncRequestState.ChannelGroups, asyncRequestState.Reconnect, asyncRequestState.Timetoken, asyncRequestState.ErrorCallback);
                                }
                            }
                        }
#if !NETFX_CORE
                ...
                ProcessResponseCallbacks<T1, T2, T3, T4>(result, asyncRequestState);
                ...
                switch (asyncRequestState.ResponseType)
                {
                    ...
                    case ResponseType.Presence:
                        MultiplexInternalCallback<T1, T2, T3, T4>(asyncRequestState.ResponseType, result, asyncRequestState.SubscribeRegularCallback, asyncRequestState.PresenceRegularCallback, asyncRequestState.ConnectCallback, asyncRequestState.WildcardPresenceCallback, asyncRequestState.ErrorCallback);
                        break;
                    default:
                        break;
                }
            ...
            catch (WebException webEx)
            {
                ...
                if (webEx.Response != null && asyncRequestState != null)
                {
                    ...
                    if (result == null && currentHttpStatusCode == HttpStatusCode.NotFound
                        ...
                        && webEx.Response.GetType().ToString() == "System.Net.Browser.ClientHttpWebResponse")
                    {
                        ProcessResponseCallbackExceptionHandler<T1, T2, T3, T4>(webEx, asyncRequestState);
                    }
                }
                else
                {
                    ...
                    ProcessResponseCallbackWebExceptionHandler<T1, T2, T3, T4>(webEx, asyncRequestState, channel, channelGroup);
                }
            }
            catch (Exception ex)
            {
                ...
                ProcessResponseCallbackExceptionHandler<T1, T2, T3, T4>(ex, asyncRequestState);
            }
        }
		#endregion
