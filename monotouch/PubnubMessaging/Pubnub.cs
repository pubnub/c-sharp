...
namespace PubNubMessaging.Core
{
	public class Pubnub
	{
        ...
        {
            return PubnubXamariniOS.TranslateDateTimeToPubnubUnixNanoSeconds(dotNetUTCDateTime);
        }

        public static DateTime TranslatePubnubUnixNanoSecondsToDateTime(long unixNanoSecondTime)
        {
            return PubnubXamariniOS.TranslatePubnubUnixNanoSecondsToDateTime(unixNanoSecondTime);
        }
