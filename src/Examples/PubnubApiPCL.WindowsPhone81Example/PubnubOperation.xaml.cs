                ...
                if (control.IsOKButtonEntered)
                {
                    ...
                    if (radNormalPublish != null && radNormalPublish.IsChecked.Value)
                    {
                        ...
                        if (publishMsg != "")
                        {
                            ...
                            {
                                pubnub.Publish(channel, intData, DisplayPublishReturnMessage, PubnubDisplayErrorMessage);
                            }
                            else if (double.TryParse(publishMsg, out doubleData)) //capture numeric data
                            {
                                pubnub.Publish(channel, doubleData, DisplayPublishReturnMessage, PubnubDisplayErrorMessage);
                            }
                            else
                            {
                                pubnub.Publish(channel, publishMsg, DisplayPublishReturnMessage, PubnubDisplayErrorMessage);
                            }
                        }
                    }
            ...
            pamAuthKeyPopup.Closed += (senderPopup, argsPopup) =>
            {
                if (control.IsOKButtonEntered)
                {
                    ...
                    if (txtPAMAuthKey != null)
                    {
                        ...
                        int ttlInMinutes = 1440;
                        pubnub.GrantAccess(channel, pamAuthKey, true, true, ttlInMinutes, DisplayGrantReturnMessage, PubnubDisplayErrorMessage);
                    }
            ...
            pamAuthKeyPopup.Closed += (senderPopup, argsPopup) =>
            {
                if (control.IsOKButtonEntered)
                {
                    ...
                    if (txtPAMAuthKey != null)
                    {
                        ...
                        DisplayMessageInTextBox("Running GrantPresenceAccess:");
                        int ttlInMinutes = 1440;
                        pubnub.GrantPresenceAccess(channel, pamAuthKey, true, true, ttlInMinutes, DisplayGrantReturnMessage, PubnubDisplayErrorMessage);
                    }
            ...
            pamAuthKeyPopup.Closed += (senderPopup, argsPopup) =>
            {
                if (control.IsOKButtonEntered)
                {
                    ...
                    if (txtPAMAuthKey != null)
                    {
                        ...
                        pubnub.GrantAccess(channel, pamAuthKey, false, false, DisplayGrantReturnMessage, PubnubDisplayErrorMessage);
                    }
            ...
            pamAuthKeyPopup.Closed += (senderPopup, argsPopup) =>
            {
                if (control.IsOKButtonEntered)
                {
                    ...
                    if (txtPAMAuthKey != null)
                    {
                        ...
                        DisplayMessageInTextBox("Running AuditAccess:");
                        pubnub.AuditAccess(channel, pamAuthKey, DisplayAuditReturnMessage, PubnubDisplayErrorMessage);
                    }
            ...
            pamAuthKeyPopup.Closed += (senderPopup, argsPopup) =>
            {
                if (control.IsOKButtonEntered)
                {
                    ...
                    if (txtPAMAuthKey != null)
                    {
                        ...
                        DisplayMessageInTextBox("Running AuditPresenceAccess:");
                        pubnub.AuditPresenceAccess(channel, pamAuthKey, DisplayAuditReturnMessage, PubnubDisplayErrorMessage);
                    }
