...
namespace PubnubMessagingExample
{
    ...
    public partial class Pubnub_MessagingSub : DialogViewController
    {
        ...
        public void DetailedHistory ()
        {
            ...
            foreach (string channel in channels) {
                InvokeInBackground (() => {
					pubnub.DetailedHistory (channel.Trim (), 100, false, DisplayDetailedHistoryReturnMessage, DisplayErrorMessage);
                });
            }
        }
            ...
            var newroot = new RootElement ("Add Channel To ChannelGroup", 0, 0) {
                ...
                new Section ("") {
                    new StyledStringElement ("Add Channel", () => {
						...
						pubnub.AddChannelsToChannelGroup(new string[]{entryChannel}, entryChannelGroup, DisplayAddChannelToChannelGroupReturnMessage, DisplayErrorMessage);
            ...
            var newroot = new RootElement ("Remove Channel From ChannelGroup", 0, 0) {
                ...
                new Section ("") {
                    new StyledStringElement ("Remove Channel", () => {
						...
						pubnub.RemoveChannelsFromChannelGroup(new string[]{entryChannel}, entryChannelGroup, DisplayRemoveChannelFromChannelGroupReturnMessage, DisplayErrorMessage);
            ...
            var newroot = new RootElement ("Get Channel List From ChannelGroup", 0, 0) {
                ...
                new Section ("") {
                    new StyledStringElement ("Get ChannelList", () => {
						...
						pubnub.GetChannelsForChannelGroup(entryChannelGroup, DisplayGetChannelsForChannelGroupReturnMessage, DisplayErrorMessage);
                    ...
                    new StyledStringElement (buttonTitle, () => {
                        ...
                        if (cds == CommonDialogStates.SetUserStateKeyPair) {
                            ...
                            if (Int32.TryParse (entryText3Val, out valueInt)) {
                                InvokeInBackground(() => {
									pubnub.SetUserState (entryText1Val, entryChannelGroupValue, new KeyValuePair<string, object> (entryText2Val, valueInt), DisplaySetUserStateReturnMessage, DisplayErrorMessage);
                                });
                            } else if (Double.TryParse (entryText3Val, out valueDouble)) {
                                InvokeInBackground(() => {
									pubnub.SetUserState (entryText1Val, entryChannelGroupValue, new KeyValuePair<string, object> (entryText2Val, valueDouble), DisplaySetUserStateReturnMessage, DisplayErrorMessage);
                                });
                            } else {
                                InvokeInBackground(() => {
									pubnub.SetUserState (entryText1Val, entryChannelGroupValue, new KeyValuePair<string, object> (entryText2Val, entryText3Val), DisplaySetUserStateReturnMessage, DisplayErrorMessage);
                                });
                            }
                        } else if (cds == CommonDialogStates.DeleteUserState) {
                            InvokeInBackground(() => {
								pubnub.SetUserState (entryText1Val, entryChannelGroupValue, new KeyValuePair<string, object> (entryText2Val, null), DisplaySetUserStateReturnMessage, DisplayErrorMessage);
                            });
                        } else if (cds == CommonDialogStates.SetUserStateJson) {
                            Display ("Setting user state");
                            string entryText3Val = entryText3.Value;
                            ...
                            InvokeInBackground(() => {
								pubnub.SetUserState (entryText1Val, entryChannelGroupValue, entryText3Val, jsonUserState, DisplaySetUserStateReturnMessage, DisplayErrorMessage);
                            });
                        } else if (cds == CommonDialogStates.GetUserState) {
                            Display ("Running get user state");
                            InvokeInBackground(() => {
								pubnub.GetUserState (entryText1Val, entryChannelGroupValue, entryText2Val, DisplayGetUserStateReturnMessage, DisplayErrorMessage);
                            });
                        }
                ...
                if (e.ButtonIndex == 0) {
                    if (alert.GetTextField (0) != null) {
                        ...
                        if (cds == CommonDialogStates.Auth) {
                            ...
                            Display ("Running Subscribe Audit");
                            InvokeInBackground(() => {
								pubnub.AuditAccess (Channel, input, DisplayAuditReturnMessage, DisplayErrorMessage);
                            });
                        } else if (cds == CommonDialogStates.AuditPresence) {
                            Display ("Running Presence Audit");
                            InvokeInBackground(() => {
								pubnub.AuditPresenceAccess (Channel, input, DisplayAuditReturnMessage, DisplayErrorMessage);
                            });
                        } else if (cds == CommonDialogStates.RevokePresence) {
                            Display ("Running Presence Revoke");
                            InvokeInBackground(() => {
								pubnub.GrantPresenceAccess (Channel, input, false, false, DisplayGrantReturnMessage, DisplayErrorMessage);
                            });
                        } else if (cds == CommonDialogStates.RevokeSubscribe) {
                            Display ("Running Subscribe Revoke");
                            InvokeInBackground(() => {
								pubnub.GrantAccess (Channel, input, false, false, DisplayGrantReturnMessage, DisplayErrorMessage);
                            });
                            ...
                            InvokeInBackground(() => {
                                pubnub.WhereNow (input, DisplayWhereNowReturnMessage, DisplayErrorMessage);
                            });
                        }
                    }
                }           
                    ...
                    new StyledStringElement (buttonTitle, () => {
                        ...
                        if ((cds == CommonDialogStates.PresenceGrant) || (cds == CommonDialogStates.SubscribeGrant)) {
                            ...
                            if (isPresenceGrant) {
                                ...
                                InvokeInBackground(() => {
									pubnub.GrantPresenceAccess (Channel, entryText2Val, be1Val, be2Val, iTtl, DisplayGrantReturnMessage, DisplayErrorMessage);
                                });
                            } else {
                                Display ("Running Subscribe Grant");
                                InvokeInBackground(() => {
									pubnub.GrantAccess (Channel, entryText2Val, be1Val, be2Val, iTtl, DisplayGrantReturnMessage, DisplayErrorMessage);
                                });
                            }
                        } else if (cds == CommonDialogStates.HereNow) {
                            ...
                            if(entryTextVal.Trim() != ""){
                                ...
                                foreach (string channel in channels) {
                                    InvokeInBackground(() => {
										pubnub.HereNow (channel.Trim ().Split(','), be1Val, be2Val, DisplayHereNowReturnMessage, DisplayErrorMessage);
                                    });
                                }
                            } else {
                            ...
                            bool be2Val = be2.Value;
                            InvokeInBackground(() => {
                                pubnub.GlobalHereNow (be1Val, be2Val, DisplayGlobalHereNowReturnMessage, DisplayErrorMessage);
                            });
                        } else if (cds == CommonDialogStates.Publish) {
                            Display ("Running Publish");
                            string entryTextVal = entryText.Value;
                            ...
                            foreach (string channel in channels) {
                                InvokeInBackground(() => {
                                    pubnub.Publish (channel.Trim (), entryTextVal, be1Val, "", DisplayPublishReturnMessage, DisplayErrorMessage);
                                });
                            }
                        }
