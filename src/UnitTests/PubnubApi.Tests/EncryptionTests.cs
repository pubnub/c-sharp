...
namespace PubNubMessaging.Tests
{
    ...
    public class EncryptionTests
    {
        ...
        {
            PNConfiguration config = new PNConfiguration(new UserId("uuid")) { UseRandomInitializationVector = true };
        ...
        public void TestYayByteArrayDecryptionBasic()
        {
            ...
            ////decrypt
            byte[] decryptedBytes = pc.Decrypt(messageBytes);
        ...
        public void TestFileEncryptionFromPath()
        {
            ...
            PNConfiguration config = new PNConfiguration(new UserId("uuid")) { UseRandomInitializationVector = true, LogVerbosity= PNLogVerbosity.BODY };
        ...
        public void TestYayByteArrayEncryptionBasic()
        {
            ...
            ////Encrypt
            byte[] encryptedBytes = pc.Encrypt(messageBytes);
