...
namespace PubNubMessaging.Tests
{
    ...
    public class WhenObjectMembership : TestHarness
    {
                        ...
                        {
                            {
                                ...
                                {
                                    Read = true, Write = true, Manage = true, Create = true, Delete = true, Get = true,
                                    Update = true, Join = true
                                }
                            },
                            {
                                channelMetadataId2,
                ...
                .Execute(new PNAccessManagerTokenResultExt(
                    (r, s) =>
                    {
                        try
                        {
                            ...
                            if (r != null)
                            {
                                Debug.WriteLine("PNAccessManagerTokenResult={0}",
                ...
                pubnub.ManageMemberships().Uuid(uuidMetadataId)
                    .Set(new List<PNMembership>()
                    {
                        new PNMembership()
                        {
                            ...
                            Custom = new Dictionary<string, object>() { { "color", "green1" } }
                        },
                        new PNMembership()
                        {
                            Channel = channelMetadataId2,
                            Custom = new Dictionary<string, object>() { { "color", "green2" } }
                        }
                    })
                    .Execute(new PNMembershipsResultExt((r, s) =>
                    {
        ...
        public static async Task
            ThenWithAsyncSetRemoveChannelMetadataWithManageMembershipShouldReturnSuccessCodeAndInfo()
#endif
        {
            server.ClearRequests();
            ...
            {
                Assert.Ignore(
                    "Ignored ThenWithAsyncSetRemoveChannelMetadataWithManageMembershipShouldReturnSuccessCodeAndInfo");
                return;
            }
            ...
            System.Diagnostics.Debug.WriteLine("pubnub.SetUuidMetadata() STARTED");
#if NET40
            PNResult<PNSetUuidMetadataResult> createUserResult =
 Task.Factory.StartNew(async () => await pubnub.SetUuidMetadata().Uuid(uuidMetadataId).Name("pandu-ut-un").ExecuteAsync()).Result.Result;
#else
            PNResult<PNSetUuidMetadataResult> createUserResult =
                await pubnub.SetUuidMetadata().Uuid(uuidMetadataId).Name("pandu-ut-un").ExecuteAsync();
#endif
            if (createUserResult.Result != null && createUserResult.Status.StatusCode == 200 &&
                !createUserResult.Status.Error)
            {
            ...
            if (receivedMessage)
            {
                ...
                System.Diagnostics.Debug.WriteLine("pubnub.SetChannelMetadata() 1 STARTED");
#if NET40
                PNResult<PNSetChannelMetadataResult> createSpace1Result =
 Task.Factory.StartNew(async () => await pubnub.SetChannelMetadata().Channel(channelMetadataId1).Name("pandu-ut-spname").ExecuteAsync()).Result.Result;
#else
                PNResult<PNSetChannelMetadataResult> createSpace1Result = await pubnub.SetChannelMetadata()
                    .Channel(channelMetadataId1).Name("pandu-ut-spname").ExecuteAsync();
#endif
                if (createSpace1Result.Result != null && createSpace1Result.Status.StatusCode == 200 &&
                    !createSpace1Result.Status.Error)
                {
            ...
            if (receivedMessage)
            {
                ...
                System.Diagnostics.Debug.WriteLine("pubnub.SetChannelMetadata() 2 STARTED");
#if NET40
                PNResult<PNSetChannelMetadataResult> createSpace2Result =
 Task.Factory.StartNew(async () => await pubnub.SetChannelMetadata().Channel(channelMetadataId2).Name("pandu-ut-spname").ExecuteAsync()).Result.Result;
#else
                PNResult<PNSetChannelMetadataResult> createSpace2Result = await pubnub.SetChannelMetadata()
                    .Channel(channelMetadataId2).Name("pandu-ut-spname").ExecuteAsync();
#endif
                if (createSpace2Result.Result != null && createSpace2Result.Status.StatusCode == 200 &&
                    !createSpace2Result.Status.Error)
                {
            ...
            if (receivedMessage)
            {
                ...
                System.Diagnostics.Debug.WriteLine("pubnub.Memberships() ADD STARTED");
#if NET40
                PNResult<PNMembershipsResult> manageMbrshipAddResult =
 Task.Factory.StartNew(async () => await pubnub.ManageMemberships().Uuid(uuidMetadataId)
                    .Set(new List<PNMembership>()
                            {
                                new PNMembership() { Channel = channelMetadataId1  },
                                new PNMembership() { Channel = channelMetadataId2  }
...
#else
                PNResult<PNMembershipsResult> manageMbrshipAddResult = await pubnub.ManageMemberships()
                    .Uuid(uuidMetadataId)
                    .Set(new List<PNMembership>()
                    {
                        new PNMembership() { Channel = channelMetadataId1 },
                    ...
                    .ExecuteAsync();
#endif
                if (manageMbrshipAddResult.Result != null && manageMbrshipAddResult.Status.StatusCode == 200 &&
                    !manageMbrshipAddResult.Status.Error)
                {
                    ...
                    if (manageMbrshipAddResult.Result.Memberships != null
                        && manageMbrshipAddResult.Result.Memberships.Find(x =>
                            x.ChannelMetadata.Channel == channelMetadataId1) != null
                        && manageMbrshipAddResult.Result.Memberships.Find(x =>
                            x.ChannelMetadata.Channel == channelMetadataId2) != null)
                    {
                        receivedMessage = true;
                    }
                }
            ...
            if (receivedMessage && !string.IsNullOrEmpty(config.SecretKey))
            {
                ...
                System.Diagnostics.Debug.WriteLine("pubnub.Memberships() UPDATE STARTED");
#if NET40
                PNResult<PNMembershipsResult> manageMbrshipUpdResult =
 Task.Factory.StartNew(async () => await pubnub.ManageMemberships().Uuid(uuidMetadataId)
                    .Set(new List<PNMembership>()
                            {
                            new PNMembership() { Channel = channelMetadataId1, Custom =
 new Dictionary<string, object>(){ { "color", "green1" } } },
                            new PNMembership() { Channel = channelMetadataId2, Custom =
 new Dictionary<string, object>(){ { "color", "green2" } } }
                    })
                    .ExecuteAsync()).Result.Result;
#else
                PNResult<PNMembershipsResult> manageMbrshipUpdResult = await pubnub.ManageMemberships()
                    .Uuid(uuidMetadataId)
                    .Set(new List<PNMembership>()
                    {
                        new PNMembership()
                    ...
                    .ExecuteAsync();
#endif
                if (manageMbrshipUpdResult.Result != null && manageMbrshipUpdResult.Status.StatusCode == 200 &&
                    !manageMbrshipUpdResult.Status.Error)
                {
                    ...
                    if (manageMbrshipUpdResult.Result.Memberships != null
                        && manageMbrshipUpdResult.Result.Memberships.Find(x =>
                            x.ChannelMetadata.Channel == channelMetadataId1) != null
                        && manageMbrshipUpdResult.Result.Memberships.Find(x =>
                            x.ChannelMetadata.Channel == channelMetadataId2) != null)
                    {
            ...
            if (receivedMessage)
            {
                ...
                System.Diagnostics.Debug.WriteLine("pubnub.Memberships() REMOVE STARTED");
#if NET40
                PNResult<PNMembershipsResult> manageMbrshipDelResult =
 Task.Factory.StartNew(async () => await pubnub.ManageMemberships().Uuid(uuidMetadataId)
                    .Remove(new List<string>() { channelMetadataId2 })
                    .ExecuteAsync()).Result.Result;
#else
                PNResult<PNMembershipsResult> manageMbrshipDelResult = await pubnub.ManageMemberships()
                    .Uuid(uuidMetadataId)
                    .Remove(new List<string>() { channelMetadataId2 })
                    .ExecuteAsync();
#endif
                if (manageMbrshipDelResult.Result != null && manageMbrshipDelResult.Status.StatusCode == 200 &&
                    !manageMbrshipDelResult.Status.Error)
                {
            ...
            if (receivedMessage)
            {
                ...
                System.Diagnostics.Debug.WriteLine("pubnub.GetMemberships() STARTED");
#if NET40
                PNResult<PNMembershipsResult> getMbrshipResult =
 Task.Factory.StartNew(async () => await pubnub.GetMemberships().Uuid(uuidMetadataId).ExecuteAsync()).Result.Result;
#else
                PNResult<PNMembershipsResult> getMbrshipResult =
                    await pubnub.GetMemberships().Uuid(uuidMetadataId).ExecuteAsync();
#endif
                if (getMbrshipResult.Result != null && getMbrshipResult.Status.StatusCode == 200 &&
                    !getMbrshipResult.Status.Error)
                {
                    pubnub.JsonPluggableLibrary.SerializeToJsonString(getMbrshipResult.Result);
                    if (getMbrshipResult.Result.Memberships != null
                        && getMbrshipResult.Result.Memberships.Find(
                            x => x.ChannelMetadata.Channel == channelMetadataId1) != null)
                    {
                        receivedMessage = true;
                    }
                }
        ...
        public static void ThenSetRemoveChannelMetadataWithSetRemoveMembershipShouldReturnSuccessCodeAndInfo()
        {
            ...
            {
                Assert.Ignore(
                    "Ignored ThenSetRemoveChannelMetadataWithSetRemoveMembershipShouldReturnSuccessCodeAndInfo");
                return;
            }
            ...
            if (receivedMessage)
            {
                ...
                pubnub.SetChannelMetadata().Channel(channelMetadataId1).Name("pandu-ut-spname")
                    ...
                    {
                        Assert.IsNotNull(r,
                            $"Set channel 1 metadata result was null. Error info: {s.ErrorData?.Information}");
            ...
            if (receivedMessage)
            {
                ...
                pubnub.SetChannelMetadata().Channel(channelMetadataId2).Name("pandu-ut-spname")
                    ...
                    {
                        Assert.IsNotNull(r,
                            $"Set channel 2 metadata result was null. Error info: {s.ErrorData?.Information}");
            ...
            if (receivedMessage)
            {
                ...
                pubnub.SetMemberships().Uuid(uuidMetadataId)
                    ...
                    {
                        Assert.IsNotNull(r,
                            $"Update memberships result was null. Error info: {s.ErrorData?.Information}");
            ...
            if (receivedMessage)
            {
                ...
                pubnub.RemoveMemberships().Uuid(uuidMetadataId)
                    ...
                    {
                        Assert.IsNotNull(r,
                            $"Remove memberships result was null. Error info: {s.ErrorData?.Information}");
...
#else
        public static async Task
            ThenWithAsyncSetRemoveChannelMetadataWithSetRemoveMembershipShouldReturnSuccessCodeAndInfo()
#endif
        {
            server.ClearRequests();
            ...
            {
                Assert.Ignore(
                    "Ignored ThenWithAsyncSetRemoveChannelMetadataWithSetRemoveMembershipShouldReturnSuccessCodeAndInfo");
                return;
            }
...
#if NET40
                PNResult<PNMembershipsResult> manageMbrshipAddResult =
 Task.Factory.StartNew(async () => await pubnub.SetMemberships().Uuid(uuidMetadataId)
                    .Channels(new List<PNMembership>()
                            {
                            new PNMembership() { Channel = channelMetadataId1  },
                            new PNMembership() { Channel = channelMetadataId2  }
                    ...
                    .ExecuteAsync()).Result.Result;
#else
                PNResult<PNMembershipsResult> manageMbrshipAddResult = await pubnub.SetMemberships()
                    .Uuid(uuidMetadataId)
                    .Channels(new List<PNMembership>()
                    {
                        new PNMembership() { Channel = channelMetadataId1 },
 ...
 new Dictionary<string, object>(){ { "color", "green2" } } }
                    ...
                    .ExecuteAsync()).Result.Result;
#else
                PNResult<PNMembershipsResult> manageMbrshipUpdResult = await pubnub.SetMemberships()
                    .Uuid(uuidMetadataId)
                    .Channels(new List<PNMembership>()
                    {
                        new PNMembership()
...
#if NET40
                PNResult<PNMembershipsResult> manageMbrshipDelResult =
 Task.Factory.StartNew(async () => await pubnub.RemoveMemberships().Uuid(uuidMetadataId)
                    .Channels(new List<string>() { channelMetadataId2 })
                    .ExecuteAsync()).Result.Result;
#else
                PNResult<PNMembershipsResult> manageMbrshipDelResult = await pubnub.RemoveMemberships()
                    .Uuid(uuidMetadataId)
                    .Channels(new List<string>() { channelMetadataId2 })
                    .ExecuteAsync();
#endif
 ...
 Task.Factory.StartNew(async () => await pubnub.GetMemberships().Uuid(uuidMetadataId).ExecuteAsync()).Result.Result;
        ...
        public static void ThenManageMembershipShouldReturnEventInfo()
        {
            ...
            ManualResetEvent manualEvent = new ManualResetEvent(false);
            pubnub.Subscribe<string>().Channels(new string[] { uuidMetadataId, channelMetadataId1, channelMetadataId2 })
                .Execute();
            manualEvent.WaitOne(2000);
            ...
            pubnub.Unsubscribe<string>()
                .Channels(new string[] { uuidMetadataId, channelMetadataId1, channelMetadataId2 }).Execute();
 ...
 Task.Factory.StartNew(async () => await pubnub.RemoveMemberships().Uuid(uuidMetadataId)
        ...
        public static async Task ThenSetMembershipsShouldHandleAllFeatures()
        {
            ...
            Assert.AreEqual(200, createUserResult.Status.StatusCode,
                "UUID metadata creation status code should be 200");
            ...
            Assert.AreEqual(200, createChannel1Result.Status.StatusCode,
                "Channel 1 metadata creation status code should be 200");
            ...
            Assert.AreEqual(200, createChannel2Result.Status.StatusCode,
                "Channel 2 metadata creation status code should be 200");
            ...
            Assert.IsTrue(
                setMembershipsResult.Result.Memberships.Any(m => m.ChannelMetadata.Channel == channelMetadataId1),
                "Should contain channel 1");
            Assert.IsTrue(
                setMembershipsResult.Result.Memberships.Any(m => m.ChannelMetadata.Channel == channelMetadataId2),
                "Should contain channel 2");
            Assert.IsTrue(
                setMembershipsResult.Result.Memberships.Any(m => m.Custom != null && m.Custom.ContainsKey("role")),
                "Should have custom data");
            ...
            Assert.AreEqual(200, updateMembershipsResult.Status.StatusCode,
                "Update memberships status code should be 200");
            ...
            Assert.IsTrue(updateMembershipsResult.Result.Memberships.Any(m =>
                m.ChannelMetadata.Channel == channelMetadataId1 &&
                m.Custom != null && m.Custom["role"].ToString() == "superadmin"), "Should have updated channel 1");
            Assert.IsTrue(
                updateMembershipsResult.Result.Memberships.Any(m => m.ChannelMetadata.Channel == channelMetadataId2),
                "Should contain channel 2");
        ...
        public static async Task ThenMembershipOperationsShouldWorkCorrectly()
        {
            ...
            Assert.IsTrue(
                getMembershipsResult.Result.Memberships.Any(m => m.ChannelMetadata.Channel == channelMetadataId1),
                "Should contain channel 1");
            Assert.IsTrue(
                getMembershipsResult.Result.Memberships.Any(m => m.ChannelMetadata.Channel == channelMetadataId2),
                "Should contain channel 2");
            ...
            Assert.AreEqual(200, manageMembershipsResult.Status.StatusCode,
                "Manage memberships status code should be 200");
            ...
            Assert.IsTrue(manageMembershipsResult.Result.Memberships.Any(m =>
                m.ChannelMetadata.Channel == channelMetadataId1 &&
                m.Custom != null && m.Custom["role"].ToString() == "superadmin"), "Should have updated channel 1");
            Assert.IsFalse(
                manageMembershipsResult.Result.Memberships.Any(m => m.ChannelMetadata.Channel == channelMetadataId2),
                "Should not contain channel 2");
            ...
            Assert.AreEqual(200, removeMembershipsResult.Status.StatusCode,
                "Remove memberships status code should be 200");
            ...
            Assert.IsFalse(
                removeMembershipsResult.Result.Memberships.Any(m => m.ChannelMetadata.Channel == channelMetadataId1),
                "Should not contain channel 1");
        ...
        [Test]
        public static async Task TestSetMembershipsObjectCallback()
        {
            string uuidMetadataId = "pandu-ut-uid";
            string channelMetadataId = "pandu-ut-sid2";
            ...
            pubnub.AddListener(eventListener);
            pubnub.Subscribe<string>().Channels(new string[] { channelMetadataId, uuidMetadataId }).WithPresence().Execute();
            await Task.Delay(2500);
            
            // Create memberships with custom data, status, and type
            var memberships = new List<PNMembership>()
            {
                new ()
                {
                    Channel = channelMetadataId,
                    Custom = new Dictionary<string, object>() { { "role", "guest" } },
                    Status = "active",
                    Type = "membership"
                }
            };
            var result = await pubnub.SetMemberships()
                .Uuid(uuidMetadataId)
                .Channels(memberships)
                .Include(new[]
                {
            ...
            {
                Assert.Fail($"SetMemberships() failed, error: {result.Status.ErrorData.Information}");
            }
