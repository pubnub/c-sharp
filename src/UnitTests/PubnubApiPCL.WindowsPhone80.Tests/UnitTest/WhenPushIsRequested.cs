    ...
    public class WhenPushIsRequested : WorkItemTest
    {
        ...
        public void Init()
        {
            ...
            ThreadPool.QueueUserWorkItem((s) =>
            {
                ...
                pubnub.GrantAccess(channel, true, true, 20, ThenPushInitializeShouldReturnGrantMessage, DummyErrorCallback);
        ...
        [Asynchronous]
        void ThenPushInitializeShouldReturnGrantMessage(GrantAck receivedMessage)
        {
            try
            {
