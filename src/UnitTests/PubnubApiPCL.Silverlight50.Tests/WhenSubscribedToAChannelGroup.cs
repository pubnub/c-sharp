    ...
    public class WhenSubscribedToAChannelGroup : WorkItemTest
    {
        ...
        public void Init()
        {
            ...
            ThreadPool.QueueUserWorkItem((s) =>
            {
                ...
                pubnub.ChannelGroupGrantAccess(channelGroupName + "," + channelGroupName1 + "," + channelGroupName2, true, true, 20, ThenChannelGroupInitializeShouldReturnGrantMessage, DummySubscribeErrorCallback);
        ...
        public void ThenSubscribeShouldReturnReceivedMessage()
        {
            ...
            ThreadPool.QueueUserWorkItem((s) =>
            {
                ...
                if (receivedChannelGroupMessage)
                {
                    ...
                    Thread.Sleep(PubnubCommon.TIMEOUT);
                    pubnub.GrantAccess(channelName, true, true, ThenChannelInitializeShouldReturnGrantMessage, DummyErrorCallback);
                    Thread.Sleep(PubnubCommon.TIMEOUT);
        ...
        [Asynchronous]
        void ThenChannelInitializeShouldReturnGrantMessage(GrantAck receivedMessage)
        {
            try
            {
                if (receivedMessage != null)
