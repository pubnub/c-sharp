...
//            string[] channel = new string[] { "hello_my_channel", "hello_my_channel-pnpres" };

//            pubnub.Grant().Channels(channel).Read(true).Write(true).Manage(false).TTL(20).Async(new PNCallback<PNAccessManagerGrantResult>() { Result = ThenPresenceInitializeShouldReturnGrantMessage, Error = DummyErrorCallback });
//            Thread.Sleep(1000);
...
//            string expected = "{\"status\": 200, \"message\": \"OK\", \"payload\": {\"channels\": {\"bot_object\": {\"uuids\": [{\"uuid\": \"0ccff0c1-aa81-421b-8c2b-08a59bd5138c\"}], \"occupancy\": 1}}, \"total_channels\": 1, \"total_occupancy\": 1}, \"service\": \"Presence\"}";
...
//            //////server.AddRequest(new Request()
//            //////        .WithMethod("GET")
//            //////        .WithPath(String.Format("/subscribe/{0}/{1}/0/14742283085315695", PubnubCommon.SubscribeKey, channel))
//            //////        .WithParameter("uuid", config.Uuid)
//            //////        .WithParameter("heartbeat", "300")
//            //////        .WithParameter("pnsdk", PubnubCommon.EncodedSDK)
//            //////        .WithResponse(expected)
