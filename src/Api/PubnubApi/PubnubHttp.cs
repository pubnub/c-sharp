...
//                    pubnubRequestState.RequestCancellationTokenSource = null;
//                }
//            }
//            return jsonString;
//        }
...
//                        HttpWebRequest asyncWebRequest = asyncRequestState.RequestCancellationTokenSource as HttpWebRequest;
...
//                                asyncRequestState.RequestCancellationTokenSource = null;
//                            }
//                        }
//                    }
//                    ), pubnubRequestState);
...
//                {
//                    HttpWebRequest request = currentState.RequestCancellationTokenSource;
//                    if (request != null)
//                    {
...
//            if (currentState != null && currentState.Response == null && currentState.RequestCancellationTokenSource != null)
//            {
//                currentState.Timeout = true;
...
//                try
//                {
//                    currentState.RequestCancellationTokenSource.Abort();
//                }
//                catch {  /* ignore */ }
