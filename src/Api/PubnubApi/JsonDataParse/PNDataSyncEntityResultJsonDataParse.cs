...
internal static class PNDataSyncEntityResultJsonDataParse
{
    internal static PNDataSyncEntityResult GetObject(IJsonPluggableLibrary jsonPlug, List<object> listObject)
    {
        Dictionary<string, object> dictionaryObject = (listObject != null && listObject.Count == 1)
            ...
            : null;
        PNDataSyncEntityResult result = null;
        if (dictionaryObject != null && dictionaryObject.ContainsKey("data"))
        {
            result = new PNDataSyncEntityResult();
