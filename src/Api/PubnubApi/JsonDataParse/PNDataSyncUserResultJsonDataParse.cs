...
internal static class PNDataSyncUserResultJsonDataParse
{
    internal static PNDataSyncUserResult GetObject(IJsonPluggableLibrary jsonPlug, List<object> listObject)
    {
        Dictionary<string, object> dictionaryObject = (listObject != null && listObject.Count == 1)
            ...
            : null;
        PNDataSyncUserResult result = null;
        if (dictionaryObject != null && dictionaryObject.ContainsKey("data"))
        {
            result = new PNDataSyncUserResult();
