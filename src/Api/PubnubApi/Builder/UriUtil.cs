...
////                        prevSurroagePair = true;
////                    }
////                    else if (forPamSign && IsUnsafeToEncode(ch, ignoreComma, ignoreColon) && IsUnsafeToEscapeForPamSign(ch))
////                    {
////                        if (tildeCharPresent)
////                        {
////                            o.Append(ch);
...
////                            string escapeChar = Encoding.UTF8.GetString(strBytes, 0, strBytes.Length);
////                            //string escapeChar = System.Uri.EscapeDataString(ch.ToString());
////                            System.Diagnostics.Debug.WriteLine(ch.ToString() + " IsUnsafeToEscapeForPamSign escapeChar = " + escapeChar);
////                            //if (escapeChar == ch.ToString())
////                            //{
////                            //    escapeChar = System.Uri.EscapeDataString(ch.ToString());
////                            //    System.Diagnostics.Debug.WriteLine(ch.ToString() + " IsUnsafeToEscapeForPamSign EscapeDataString = " + escapeChar);
////                            //    //escapeChar = string.Format("%{0}{1}", ToHex(ch / 16), ToHex(ch % 16));
////                            //}
////#if NET3511 || NET4011
////                                                    if (escapeChar == ch.ToString())
...
////                        }
////#endif
////                        //System.Diagnostics.Debug.WriteLine(ch.ToString() + " else cond = " + escapeChar);
////                        o.Append(escapeChar);
////                    }
////                }
////            }
