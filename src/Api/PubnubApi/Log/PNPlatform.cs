...
namespace PubnubApi
{
    ...
    {
        public static void Print(PNConfiguration config)
        {
            #if NETSTANDARD10
            ...
            #else
                        LoggingMethod.WriteToLog(string.Format("DateTime {0} PLATFORM = UNKNOWN", DateTime.Now.ToString()), config.LogVerbosity);
            #endif
        }
    }
}
