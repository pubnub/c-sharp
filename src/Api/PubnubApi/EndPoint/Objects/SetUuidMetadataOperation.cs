...
namespace PubnubApi.EndPoint
{
    public class SetUuidMetadataOperation : PubnubCoreBase
    {
        ...
        private void SetUuidMetadata(string uuid, bool includeCustom, Dictionary<string, object> externalQueryParam,
            PNCallback<PNSetUuidMetadataResult> callback)
        {
            ...
            var transportRequest = PubnubInstance.transportMiddleware.PreapareTransportRequest(
                requestParameter: requestParameter, operationType: PNOperationType.PNSetUuidMetadataOperation);
            ...
            Dictionary<string, object> externalQueryParam)
        {
            ...
            if (transportResponse.Error == null)
            {
                ...
                if (!string.IsNullOrEmpty(json))
                {
                    ...
                    PNSetUuidMetadataResult responseResult =
