...
namespace PubnubApi.EndPoint
{
    public class SetChannelMembersOperation : PubnubCoreBase
    {
        ...
        public SetChannelMembersOperation(PNConfiguration pubnubConfig, IJsonPluggableLibrary jsonPluggableLibrary, IPubnubUnitTest pubnubUnit, IPubnubLog log, EndPoint.TelemetryManager telemetryManager, Pubnub instance) : base(pubnubConfig, jsonPluggableLibrary, pubnubUnit, log, telemetryManager, instance)
        {
            config = pubnubConfig;
        ...
        public SetChannelMembersOperation Include(PNMemberField[] includeOptions)
        {
