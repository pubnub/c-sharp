...
namespace PubnubApi.EndPoint
{
	internal class GenerateFileUploadUrlOperation : PubnubCoreBase
	{
		...
		public GenerateFileUploadUrlOperation(PNConfiguration pubnubConfig, IJsonPluggableLibrary jsonPluggableLibrary, IPubnubUnitTest pubnubUnit, EndPoint.TokenManager tokenManager, Pubnub instance) : base(pubnubConfig, jsonPluggableLibrary, pubnubUnit, tokenManager, instance)
		{
			config = pubnubConfig;
		...
		{
			logger?.Debug(() => $"{GetType().Name} " + PubnubLogFormatter.Parameters("GenerateFileUploadUrl",
				("channel", channelName),
