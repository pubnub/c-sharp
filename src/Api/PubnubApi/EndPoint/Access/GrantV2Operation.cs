...
{
    public class GrantV2Operation : PubnubCoreBase
    {
        ...
        public GrantV2Operation(PNConfiguration pubnubConfig, IJsonPluggableLibrary jsonPluggableLibrary, IPubnubUnitTest pubnubUnit, IPubnubLog log, EndPoint.TelemetryManager telemetryManager, Pubnub instance) : base(pubnubConfig, jsonPluggableLibrary, pubnubUnit, log, telemetryManager, instance)
        {
            config = pubnubConfig;
        ...
        public GrantV2Operation Channels(string[] channels)
        {
            this.pubnubChannelNames = channels;
            return this;
        }

        public GrantV2Operation ChannelGroups(string[] channelGroups)
        {
            this.pubnubChannelGroupNames = channelGroups;
            return this;
        }

        public GrantV2Operation AuthKeys(string[] authKeys)
        {
            this.pamAuthenticationKeys = authKeys;
            return this;
        }

        public GrantV2Operation Write(bool write)
        {
            this.grantWrite = write;
            return this;
        }

        public GrantV2Operation Read(bool read)
        {
            this.grantRead = read;
            return this;
        }

        public GrantV2Operation Manage(bool manage)
        {
            this.grantManage = manage;
            return this;
        }

        public GrantV2Operation Delete(bool delete)
        {
            this.grantDelete = delete;
            return this;
        }

        public GrantV2Operation TTL(long ttl)
        {
            this.grantTTL = ttl;
            return this;
        }

        public GrantV2Operation QueryParam(Dictionary<string, object> customQueryParam)
        {
