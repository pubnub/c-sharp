...
{
    public class GetRelationshipOperation : PubnubCoreBase
    {
        private readonly PNConfiguration config;
        private readonly IJsonPluggableLibrary jsonLibrary;
        private readonly IPubnubUnitTest unit;
        private readonly GetRelationshipParameters parameters;

        private PNCallback<PNDataSyncRelationshipResult> savedCallback;

        private const PNOperationType OperationType = PNOperationType.PNDataSyncGetRelationship;

        public GetRelationshipOperation(PNConfiguration pubnubConfig, IJsonPluggableLibrary jsonPluggableLibrary,
            IPubnubUnitTest pubnubUnit, TokenManager tokenManager, Pubnub instance,
            GetRelationshipParameters parameters) : base(pubnubConfig,
        ...
        public async Task<PNResult<PNDataSyncRelationshipResult>> ExecuteAsync()
        {
            ...
            return await GetRelationshipAsync().ConfigureAwait(false);
        }
        ...
        private async Task<PNResult<PNDataSyncRelationshipResult>> GetRelationshipAsync()
        {
