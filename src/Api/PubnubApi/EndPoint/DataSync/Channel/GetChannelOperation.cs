...
{
    public class GetChannelOperation : PubnubCoreBase
    {
        private readonly PNConfiguration config;
        private readonly IJsonPluggableLibrary jsonLibrary;
        private readonly IPubnubUnitTest unit;
        private readonly GetChannelParameters parameters;

        private PNCallback<PNDataSyncChannelResult> savedCallback;

        private const PNOperationType OperationType = PNOperationType.PNDataSyncGetChannel;

        public GetChannelOperation(PNConfiguration pubnubConfig, IJsonPluggableLibrary jsonPluggableLibrary,
            IPubnubUnitTest pubnubUnit, TokenManager tokenManager, Pubnub instance,
            GetChannelParameters parameters) : base(pubnubConfig,
        ...
        public async Task<PNResult<PNDataSyncChannelResult>> ExecuteAsync()
        {
            ...
            return await GetChannelAsync().ConfigureAwait(false);
        }
        ...
        private async Task<PNResult<PNDataSyncChannelResult>> GetChannelAsync()
        {
