...
{
    public class CreateChannelOperation : PubnubCoreBase
    {
        private readonly PNConfiguration config;
        private readonly IJsonPluggableLibrary jsonLibrary;
        private readonly IPubnubUnitTest unit;
        private readonly CreateChannelParameters parameters;

        private PNCallback<PNDataSyncChannelResult> savedCallback;
        
        private const PNOperationType OperationType = PNOperationType.PNDataSyncCreateChannel;

        public CreateChannelOperation(PNConfiguration pubnubConfig, IJsonPluggableLibrary jsonPluggableLibrary,
            IPubnubUnitTest pubnubUnit, TokenManager tokenManager, Pubnub instance,
            CreateChannelParameters parameters) : base(pubnubConfig,
        ...
        public async Task<PNResult<PNDataSyncChannelResult>> ExecuteAsync()
        {
            ...
            return await CreateChannelAsync().ConfigureAwait(false);
        }
        ...
        private async Task<PNResult<PNDataSyncChannelResult>> CreateChannelAsync()
        {
