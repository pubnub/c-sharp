...
{
    public class GetMembershipOperation : PubnubCoreBase
    {
        private readonly PNConfiguration config;
        private readonly IJsonPluggableLibrary jsonLibrary;
        private readonly IPubnubUnitTest unit;
        private readonly GetMembershipParameters parameters;

        private PNCallback<PNDataSyncMembershipResult> savedCallback;

        private const PNOperationType OperationType = PNOperationType.PNDataSyncGetMembership;

        public GetMembershipOperation(PNConfiguration pubnubConfig, IJsonPluggableLibrary jsonPluggableLibrary,
            IPubnubUnitTest pubnubUnit, TokenManager tokenManager, Pubnub instance,
            GetMembershipParameters parameters) : base(pubnubConfig,
        ...
        public async Task<PNResult<PNDataSyncMembershipResult>> ExecuteAsync()
        {
            ...
            return await GetMembershipAsync().ConfigureAwait(false);
        }
        ...
        private async Task<PNResult<PNDataSyncMembershipResult>> GetMembershipAsync()
        {
