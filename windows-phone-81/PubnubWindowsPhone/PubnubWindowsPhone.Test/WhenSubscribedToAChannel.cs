...
namespace PubnubWindowsStore.Test
{
    ...
    public class WhenSubscribedToAChannel
    {
        ...
        public void ThenSubscribeShouldReturnReceivedMessage()
        {
            ...
            meSubscribeNoConnect = new ManualResetEvent(false);
            mePublish = new ManualResetEvent(false);
            meUnsubscribe = new ManualResetEvent(false);
        ...
        public void ThenSubscribeShouldReturnConnectStatus()
        {
            ...
            meSubscribeYesConnect = new ManualResetEvent(false);
        ...
        public void ThenMultiSubscribeShouldReturnConnectStatus()
        {
            ...
            meChannel1SubscribeConnect = new ManualResetEvent(false);
            meChannel2SubscribeConnect = new ManualResetEvent(false);
        ...
        public void ThenDuplicateChannelShouldReturnAlreadySubscribed()
        {
            ...
            meAlreadySubscribed = new ManualResetEvent(false);
        ...
        public void ThenSubscriberShouldBeAbleToReceiveManyMessages()
        {
            ...
            string channel = "hello_my_channel";
            subscribeEvent = new ManualResetEvent(false);
            meSubscriberManyMessages = new ManualResetEvent(false);
