...
namespace PubnubWindowsPhone.Test.UnitTest
{
    public class PubnubUnitTest : IPubnubUnitTest
    {
        ...
        private Dictionary<string, string> LoadWhenAMessageIsPublishedThenSecretKeyWithEncryptPublishShouldReturnSuccessCodeAndInfo()
        {
            Dictionary<string, string> data = new Dictionary<string, string>();
#if (SILVERLIGHT || WINDOWS_PHONE)
            data.Add("/publish/demo/demo/f377f886fada25afdf617739af129c2b/hello_my_channel/0/%22f42pIQcWZ9zbTbH8cyLwB/tdvRxjFLOYcBNMVKeHS54%3D%22", "[1,\"Sent\",\"13559014566792817\"]");
        ...
        private Dictionary<string, string> LoadWhenAMessageIsPublishedThenOptionalSecretKeyShouldBeProvidedInConstructor()
        {
            ...
            data.Add("/publish/demo/demo/20881fd95e10c440b24f79baf0e4cdb7/hello_my_channel/0/%22Pubnub%20API%20Usage%20Example%22", "[1,\"Sent\",\"13559014566792817\"]");
            return data;
        }
        ...
        {
            Dictionary<string, string> data = new Dictionary<string, string>();
            data.Add("/subscribe/demo/hello_my_channel/0/0", "[[],\"a`a`a```a`aaaa``13559006802662768\"]");
            data.Add("/subscribe/demo/hello_my_channel/0/13559006802662768", "[[],\"13559006802662768\"]");
            return data;
        }
        ...
        private Dictionary<string, string> LoadGrantRequestUnitTestInit2()
        {
            ...
            data.Add("/v1/auth/grant/sub-key/demo", "{\"status\":200,\"message\":\"Success\",\"payload\":{\"channels\":{\"hello_my_channel\":{\"r\":1,\"w\":1},\"hello_my_channel-pnpres\":{\"r\":1,\"w\":1}},\"subscribe_key\":\"demo\",\"level\":\"channel\"},\"service\":\"Access Manager\"}");
            return data;
        }
