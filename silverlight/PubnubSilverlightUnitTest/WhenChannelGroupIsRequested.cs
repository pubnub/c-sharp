...
{
    [TestClass]
    public class WhenChannelGroupIsRequested : SilverlightTest
    {
            ...
            ThreadPool.QueueUserWorkItem((s) =>
                {
                    ...
                    EnqueueCallback(() => pubnub.ChannelGroupGrantAccess<string>(channelGroupName, true, true, 20, ThenChannelGroupInitializeShouldReturnGrantMessage, DummyErrorCallback));
            ...
            ThreadPool.QueueUserWorkItem((s) =>
                {
                    ...
                    EnqueueCallback(() => pubnub.GetChannelsForChannelGroup<string>(channelGroupName, ChannelGroupCRUDCallback, DummyErrorCallback));
