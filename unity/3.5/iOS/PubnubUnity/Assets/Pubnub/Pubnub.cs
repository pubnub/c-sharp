...
namespace PubNubMessaging.Core
{
    public class Pubnub
    {
        ...
        {
			return PubnubUnityiOS.TranslateDateTimeToPubnubUnixNanoSeconds (dotNetUTCDateTime);
        }

        public static DateTime TranslatePubnubUnixNanoSecondsToDateTime (long unixNanoSecondTime)
        {
			return PubnubUnityiOS.TranslatePubnubUnixNanoSecondsToDateTime (unixNanoSecondTime);
        }
