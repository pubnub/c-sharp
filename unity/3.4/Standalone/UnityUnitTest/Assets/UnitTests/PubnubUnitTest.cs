...
namespace PubNubMessaging.Tests
{
    public class PubnubUnitTest : IPubnubUnitTest
    {
        ...
        {
            Dictionary<string, string> data = new Dictionary<string, string>();
            data.Add("/publish/demo/demo/3f75435fcd800f5d0476fc0fb5b572d1/hello_my_channel/0/%22f42pIQcWZ9zbTbH8cyLwB%2FtdvRxjFLOYcBNMVKeHS54%3D%22", "[1,\"Sent\",\"13559014566792817\"]");
        ...
        public string GetStubResponse(HttpWebRequest request)
        {
			...
			if (_testCaseName == "DetailedHistoryStartWithReverseTrue")
			{
