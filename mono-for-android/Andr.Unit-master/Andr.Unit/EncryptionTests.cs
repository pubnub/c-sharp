...
namespace PubNubMessaging.Tests
{
    ...
    public class EncryptionTests
    {
        ...
        public void TestNullDecryption()
        {
            ...
            Assert.Equals("", decryptedMessage);
        }
        ...
        public void TestYayDecryptionBasic()
        {
            ...
            string decryptedMessage = pc.Decrypt(message);
            //deserialize again
            Assert.True("yay!" == decryptedMessage);
        }
        ...
        public void TestYayEncryptionBasic()
        {
            ...
            //Encrypt
            string encryptedMessage = pc.Encrypt(message);
            Assert.True("q/xJqqN6qbiZMXYmiQC1Fw==" == encryptedMessage);
        }
        ...
        public void TestYayEncryption()
        {
            ...
            Assert.True("Wi24KS4pcTzvyuGOHubiXg==" == enc);
        }
        ...
        public void TestArrayEncryption()
        {
            ...
            Assert.True("Ns4TB41JjT2NCXaGLWSPAQ==" == encryptedMessage);
        }
        ...
        public void TestArrayDecryption()
        {
            ...
            Assert.True(result == decryptedMessage);
        }
        ...
        public void TestObjectEncryption()
        {
            ...
            Assert.True("IDjZE9BHSjcX67RddfCYYg==" == encryptedMessage);
        }
        /// <summary>
        ...
        public void TestMyObjectEncryption()
        {
            ...
            Assert.True("Zbr7pEF/GFGKj1rOstp0tWzA4nwJXEfj+ezLtAr8qqE=" == encryptedMessage);
        }
        /// <summary>
        ...
        public void TestPubNubDecryption2()
        {
            ...
            //Deserialize
            message = JsonConvert.DeserializeObject<string>(decryptedMessage);
            Assert.True("Pubnub Messaging API 2" == message);
        }
        ...
        public void TestPubNubEncryption1()
        {
            ...
            Assert.True("f42pIQcWZ9zbTbH8cyLwByD/GsviOE0vcREIEVPARR0=" == encryptedMessage);
        }
        ...
        public void TestPubNubDecryption1()
        {
            ...
            Assert.True("Pubnub Messaging API 1" == message);
        }
        ...
        public void TestStuffCanEncryption()
        {
            ...
            Assert.True("zMqH/RTPlC8yrAZ2UhpEgLKUVzkMI2cikiaVg30AyUu7B6J0FLqCazRzDOmrsFsF" == encryptedMessage);
        }
        ...
        public void TestStuffcanDecryption()
        {
            ...
            Assert.True("{\"this stuff\":{\"can get\":\"complicated!\"}}" == decryptedMessage);
        }
        ...
        public void TestHashEncryption()
        {
            ...
            Assert.True("GsvkCYZoYylL5a7/DKhysDjNbwn+BtBtHj2CvzC4Y4g=" == encryptedMessage);
        }
        ...
        public void TestHashDecryption()
        {
            ...
            Assert.True("{\"foo\":{\"bar\":\"foobar\"}}" == decryptedMessage);
        }
        ...
        public void TestUnicodeCharsEncryption()
        {
            ...
            Assert.True("+BY5/miAA8aeuhVl4d13Kg==" == encryptedMessage);
        }
        ...
        public void TestGermanCharsEncryption()
        {
            ...
            string encryptedMessage = pc.Encrypt(message);
            Console.WriteLine(encryptedMessage);
            Assert.True("stpgsG1DZZxb44J7mFNSzg==" == encryptedMessage);
        }
        ...
        public void TestPAMSignature()
        {
            ...
            Assert.True("mIoxTVM2WAM5j-M2vlp9bVblDLoZQI5XIoYyQ48U0as=" == signature);
        }
        /// <summary>
        /// Tests the cipher.
        /// </summary>
        ...
        public void  TestCipher ()
        {
            ...
            Assert.Equals("67a4f45f0d1d9bc606486fc42dc49416", strCipher);
        }*/
