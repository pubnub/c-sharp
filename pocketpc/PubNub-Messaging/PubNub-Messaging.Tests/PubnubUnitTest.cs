...
//                {
//                    HttpWebResponse stubWebResponse = new HttpWebResponse(new MemoryStream(Encoding.UTF8.GetBytes(stubResponse)), HttpStatusCode.BadRequest);
//#if (SILVERLIGHT || WINDOWS_PHONE || NETFX_CORE)
...
//                }
            ...
            else if (responseDictionary != null)
            {
                ...
                else if (requestUri.PathAndQuery.IndexOf("&pnsdk=") > 0)
                {
