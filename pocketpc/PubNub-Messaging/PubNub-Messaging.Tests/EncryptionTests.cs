...
namespace PubNubMessaging.Tests
{
    ...
    public class EncryptionTests
    {
        ...
        public void TestNullDecryption()
        {
            ...
            Assert.That("" == decryptedMessage, "TestNullDecryption failed");
        }
        ...
        public void TestYayDecryptionBasic()
        {
            ...
            Assert.That("yay!" == decryptedMessage, "TestYayDecryptionBasic failed");
        }
        ...
        public void TestYayEncryptionBasic()
        {
            ...
            Assert.That("q/xJqqN6qbiZMXYmiQC1Fw==" == encryptedMessage, "TestYayEncryptionBasic failed");
        }
        ...
        public void TestYayEncryption()
        {
            ...
            Assert.That("Wi24KS4pcTzvyuGOHubiXg==" == enc);
        }
        ...
        public void TestArrayEncryption()
        {
            ...
            Assert.That("Ns4TB41JjT2NCXaGLWSPAQ==" == encryptedMessage);
        }
        ...
        public void TestArrayDecryption()
        {
            ...
            Assert.That(result == decryptedMessage);
        }
        ...
        public void TestMyObjectEncryption()
        {
            ...
            Assert.That("Zbr7pEF/GFGKj1rOstp0tWzA4nwJXEfj+ezLtAr8qqE=" == encryptedMessage);
        }
        /// <summary>
        ...
        public void TestPubNubEncryption2()
        {
            ...
            Assert.That("f42pIQcWZ9zbTbH8cyLwB/tdvRxjFLOYcBNMVKeHS54=" == encryptedMessage);
        }
        ...
        public void TestPubNubDecryption2()
        {
            ...
            //Deserialize
            message = JsonConvert.DeserializeObject<string>(decryptedMessage);
            Assert.That("Pubnub Messaging API 2" == message);
        }
        ...
        public void TestPubNubEncryption1()
        {
            ...
            Assert.That("f42pIQcWZ9zbTbH8cyLwByD/GsviOE0vcREIEVPARR0=" == encryptedMessage);
        }
        ...
        public void TestPubNubDecryption1()
        {
            ...
            Assert.That("Pubnub Messaging API 1" == message);
        }
        ...
        public void TestStuffCanEncryption()
        {
            ...
            Assert.That("zMqH/RTPlC8yrAZ2UhpEgLKUVzkMI2cikiaVg30AyUu7B6J0FLqCazRzDOmrsFsF" == encryptedMessage);
        }
        ...
        public void TestStuffcanDecryption()
        {
            ...
            Assert.That("{\"this stuff\":{\"can get\":\"complicated!\"}}" == decryptedMessage);
        }
        ...
        public void TestHashEncryption()
        {
            ...
            Assert.That("GsvkCYZoYylL5a7/DKhysDjNbwn+BtBtHj2CvzC4Y4g=" == encryptedMessage);
        }
        ...
        public void TestHashDecryption()
        {
            ...
            Assert.That("{\"foo\":{\"bar\":\"foobar\"}}" == decryptedMessage);
        }
        ...
        public void TestUnicodeCharsEncryption()
        {
            ...
            Assert.That("+BY5/miAA8aeuhVl4d13Kg==" == encryptedMessage);
        }
        ...
        public void TestGermanCharsEncryption()
        {
            ...
            string encryptedMessage = pc.Encrypt(message);
            Console.WriteLine(encryptedMessage);
            Assert.That("stpgsG1DZZxb44J7mFNSzg==" == encryptedMessage);
        }
        ...
        public void TestPAMSignature()
        {
            ...
            Assert.That("mIoxTVM2WAM5j-M2vlp9bVblDLoZQI5XIoYyQ48U0as=" == signature);
        }
