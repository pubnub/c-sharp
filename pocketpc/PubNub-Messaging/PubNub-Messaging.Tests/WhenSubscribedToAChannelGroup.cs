...
namespace PubNubMessaging.Tests
{
    ...
    public class WhenSubscribedToAChannelGroup
    {
        ...
        public void Init()
        {
            ...
            pubnub = null;
            Assert.True(receivedGrantMessage, "WhenSubscribedToAChannelGroup Grant access failed.");
        }
        ...
        public void ThenSubscribeShouldReturnReceivedMessage()
        {
            ...
            if (receivedChannelGroupMessage)
            {
                ...
                mePublish.WaitOne(manualResetEventsWaitTimeout, false);
                ...
                Assert.True(receivedMessage, "WhenSubscribedToAChannelGroup --> ThenItShouldReturnReceivedMessage Failed");
            }
            else
            {
                Assert.True(receivedChannelGroupMessage, "WhenSubscribedToAChannelGroup --> ThenItShouldReturnReceivedMessage Failed");
            }
        ...
        public void ThenMultiSubscribeShouldReturnConnectStatus()
        {
            ...
            if (receivedChannelGroupMessage1 && receivedChannelGroupMessage2)
            {
                ...
                Assert.True(receivedMessage, "WhenSubscribedToAChannelGroup --> ThenMultiSubscribeShouldReturnConnectStatusFailed");
            }
            else
            {
                Assert.True(receivedChannelGroupMessage1 && receivedChannelGroupMessage2, "WhenSubscribedToAChannelGroup --> ThenMultiSubscribeShouldReturnConnectStatusFailed");
            }
        }
