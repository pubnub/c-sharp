...
namespace PubNubMessaging.Tests
{
    ...
    public class WhenPushIsRequested
    {
        ...
        public void ThenPublishMpnsFlipTileShouldReturnSuccess()
        {
            ...
            pubnub.PubnubUnitTest = null;
            pubnub = null;
            Assert.True(receivedSuccessMessage, "Flip Tile Publish Failed");
        }
        ...
        public void ThenPublishMpnsCycleTileShouldReturnSuccess()
        {
            ...
            pubnub.PubnubUnitTest = null;
            pubnub = null;
            Assert.True(receivedSuccessMessage, "Cycle Tile Publish Failed");
        }
        ...
        public void ThenPublishMpnsIconicTileShouldReturnSuccess()
        {
            ...
            pubnub.PubnubUnitTest = null;
            pubnub = null;
            Assert.True(receivedSuccessMessage, "Iconic Tile Publish Failed");
        }
