    ...
    public class WhenGrantIsRequested
    {
        ...
        public void ThenMultipleChannelGrantShouldReturnSuccess()
        {
            ...
            for (int index = 0; index < multipleChannelGrantCount; index++)
            {
                ...
                {
                    channelBuilder.AppendFormat(CultureInfo.InvariantCulture, "csharp-hello_my_channel-{0}", index);
                }
                else
                {
                    channelBuilder.AppendFormat(CultureInfo.InvariantCulture, "csharp-hello_my_channel-{0},", index);
        ...
        public void ThenMultipleAuthGrantShouldReturnSuccess()
        {
            ...
            for (int index = 0; index < multipleAuthGrantCount; index++)
            {
                ...
                {
                    authKeyBuilder.AppendFormat(CultureInfo.InvariantCulture, "csharp-auth_key-{0}", index);
                }
                else
                {
                    authKeyBuilder.AppendFormat(CultureInfo.InvariantCulture, "csharp-auth_key-{0},", index);
        ...
        public void ThenRevokeAtSubKeyLevelReturnSuccess()
        {
            ...
            if (PubnubCommon.PAMEnabled)
            {
                ...
                if (receivedGrantMessage)
                {
                    ...
                    Thread.Sleep(1000);
                    revokeManualEvent.WaitOne(10 * 1000, false);
        ...
        public void ThenChannelGroupLevelWithReadManageShouldReturnSuccess()
        {
            ...
            if (PubnubCommon.PAMEnabled)
            {
                ...
                pubnub.PubnubUnitTest = null;
                pubnub = null;
                Assert.True(receivedGrantMessage, "WhenGrantIsRequested -> ThenChannelGroupLevelWithReadManageShouldReturnSuccess failed.");
            }
            else
            {
        ...
        public void ThenChannelGroupLevelWithReadShouldReturnSuccess()
        {
            ...
            if (PubnubCommon.PAMEnabled)
            {
                ...
                pubnub.PubnubUnitTest = null;
                pubnub = null;
                Assert.True(receivedGrantMessage, "WhenGrantIsRequested -> ThenChannelGroupLevelWithReadShouldReturnSuccess failed.");
            }
            else
            {
