...
namespace PubNubMessaging.Tests
{
    ...
    public class WhenDetailedHistoryIsRequested
    {
        ...
        public void Init()
        {
            ...
            pubnub = null;
            Assert.True(receivedGrantMessage, "WhenDetailedHistoryIsRequested Grant access failed.");
        }
        ...
        public void DetailHistoryNoStoreShouldNotGetMessage()
        {
            ...
            if (!isPublished)
            {
                Assert.True(isPublished, "No Store Publish Failed");
            }
            else
            {
                Thread.Sleep(1000);
                ...
                Assert.True(!messageReceived, "Message stored for Publish when no store is expected");
            }
            pubnub.EndPendingRequests(); 
            pubnub.PubnubUnitTest = null;
            pubnub = null;
        ...
        public void DetailHistoryShouldReturnDecryptMessage()
        {
            ...
            if (!isPublished)
            {
                Assert.True(isPublished, "Encrypted message Publish Failed");
            }
            else
            {
                Thread.Sleep(1000);
                ...
                Assert.True(messageReceived, "Encrypted message not showed up in history");
            }
            pubnub.EndPendingRequests(); 
            pubnub.PubnubUnitTest = null;
            pubnub = null;
        ...
        public void DetailHistoryCount10ReturnsRecords()
        {
            ...
            pubnub.PubnubUnitTest = null;
            pubnub = null;
            Assert.True(messageReceived, "Detailed History Failed");
        }
        ...
        public void DetailHistoryCount10ReverseTrueReturnsRecords()
        {
            ...
            mreMessageCount10ReverseTrue.WaitOne(310 * 1000, false);

            pubnub.EndPendingRequests(); 
            pubnub.PubnubUnitTest = null;
            pubnub = null;
            Assert.True(message10ReverseTrueReceived, "Detailed History Failed");
        }
        ...
        public void DetailHistoryShouldReturnUnencrypedSecretMessage()
        {
            ...
            Assert.True(messageReceived, "DetailHistoryShouldReturnUnencrypedSecretMessage - Detailed History Result not expected");
        }
        ...
        public void DetailHistoryShouldReturnUnencrypedMessage()
        {
            ...
            Assert.True(messageReceived, "DetailHistoryShouldReturnUnencrypedMessage - Detailed History Result not expected");
        }
        ...
        public void DetailHistoryShouldReturnUnencrypedSecretSSLMessage()
        {
            ...
            Assert.True(messageReceived, "DetailHistoryShouldReturnUnencrypedSecretSSLMessage - Detailed History Result not expected");
        }
        ...
        public void DetailHistoryShouldReturnUnencrypedSSLMessage()
        {
            ...
            Assert.True(messageReceived, "DetailHistoryShouldReturnUnencrypedSSLMessage - Detailed History Result not expected");
        }
        ...
        public void DetailHistoryShouldReturnEncrypedMessage()
        {
            ...
            Assert.True(messageReceived, "DetailHistoryShouldReturnEncrypedMessage - Detailed History Result not expected");
        }
        ...
        public void DetailHistoryShouldReturnEncrypedSecretMessage()
        {
            ...
            Assert.True(messageReceived, "DetailHistoryShouldReturnEncrypedSecretMessage - Detailed History Result not expected");
        }
        ...
        public void DetailHistoryShouldReturnEncrypedSecretSSLMessage()
        {
            ...
            Assert.True(messageReceived, "DetailHistoryShouldReturnEncrypedSecretSSLMessage - Detailed History Result not expected");
        }
        ...
        public void DetailHistoryShouldReturnEncrypedSSLMessage()
        {
            ...
            Assert.True(messageReceived, "DetailHistoryShouldReturnEncrypedSSLMessage - Detailed History Result not expected");
        }
                ...
                if (deserializedMessage != null && deserializedMessage.Count > 0)
                {
                    ...
                    if (message != null)
                    {
                        if (message.Length >= expectedCountAtStartTimeWithReverseTrue)
                        {
                            ...
                            {
                                if (item.ToString().IndexOf("DetailedHistoryStartTimeWithReverseTrue") >= 0)
                                {
