...
namespace PubNubMessaging.Tests
{
    ...
    public class WhenAMessageIsPublished
    {
        ...
        public void ThenUnencryptPublishShouldReturnSuccessCodeAndInfo()
        {
            ...
            manualResetEventsWaitTimeout = (unitTest.EnableStubTest) ? 20*1000 : 310 * 1000;
            mreUnencryptedPublish.WaitOne(manualResetEventsWaitTimeout, false);
            ...
            else
            {
                ...
                mreUnencryptDetailedHistory.WaitOne(manualResetEventsWaitTimeout, false);
        ...
        public void ThenUnencryptObjectPublishShouldReturnSuccessCodeAndInfo()
        {
            ...
            mreUnencryptObjectPublish.WaitOne(manualResetEventsWaitTimeout, false);
            ...
            else
            {
                ...
                mreUnencryptObjectDetailedHistory.WaitOne(manualResetEventsWaitTimeout, false);
        ...
        public void ThenEncryptObjectPublishShouldReturnSuccessCodeAndInfo()
        {
            ...
            manualResetEventsWaitTimeout = (unitTest.EnableStubTest) ? 1000 : 310 * 1000;
            mreEncryptObjectPublish.WaitOne(manualResetEventsWaitTimeout, false);
            ...
            else
            {
                ...
                mreEncryptObjectDetailedHistory.WaitOne(manualResetEventsWaitTimeout, false);
        ...
        public void ThenEncryptPublishShouldReturnSuccessCodeAndInfo()
        {
            ...
            manualResetEventsWaitTimeout = (unitTest.EnableStubTest) ? 1000 : 310 * 1000;
            mreEncryptPublish.WaitOne(manualResetEventsWaitTimeout, false);
            ...
            else
            {
                ...
                mreEncryptDetailedHistory.WaitOne(manualResetEventsWaitTimeout, false);
        ...
        public void ThenSecretKeyWithEncryptPublishShouldReturnSuccessCodeAndInfo()
        {
            ...
            manualResetEventsWaitTimeout = (unitTest.EnableStubTest) ? 1000 : 310 * 1000;
            mreSecretEncryptPublish.WaitOne(manualResetEventsWaitTimeout, false);
            ...
            else
            {
                ...
                mreSecretEncryptDetailedHistory.WaitOne(manualResetEventsWaitTimeout, false);
        ...
        public void ThenComplexMessageObjectShouldReturnSuccessCodeAndInfo()
        {
            ...
            mreComplexObjectPublish.WaitOne(manualResetEventsWaitTimeout, false);
            ...
            else
            {
                ...
                mreComplexObjectDetailedHistory.WaitOne(manualResetEventsWaitTimeout, false);
        ...
        public void ThenDisableJsonEncodeShouldSendSerializedObjectMessage()
        {
            ...
            manualResetEventsWaitTimeout = (unitTest.EnableStubTest) ? 1000 : 310 * 1000;
            mreSerializedObjectMessageForPublish.WaitOne(manualResetEventsWaitTimeout, false);
            ...
            else
            {
                ...
                mreSerializedMessagePublishDetailedHistory.WaitOne(manualResetEventsWaitTimeout, false);
        ...
        public void ThenLargeMessageShoudFailWithMessageTooLargeInfo()
        {
            ...
            manualResetEventsWaitTimeout = (unitTest.EnableStubTest) ? 310 * 1000 : 310 * 1000;
            mreLaregMessagePublish.WaitOne(manualResetEventsWaitTimeout, false);
        ...
        public void ThenOptionalSecretKeyShouldBeProvidedInConstructor()
        {
            ...
            mreOptionalSecretKeyPublish.WaitOne(310 * 1000, false);
        ...
        public void IfSSLNotProvidedThenDefaultShouldBeFalse()
        {
            ...
            mreNoSslPublish.WaitOne(310 * 1000, false);
