...
namespace PubNubMessaging.Core
{
	...
	public class PubnubClientError
	{
		...
		public override string ToString()
		{
			...
			errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "StatusCode={0} ", _statusCode);
            errorBuilder.Append(PortableEnvironment.NewLine);
			errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "Severity={0} ", _errorSeverity.ToString());
			errorBuilder.Append(PortableEnvironment.NewLine);
			errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "MessageSource={0} ", _messageSource.ToString());
			errorBuilder.Append(PortableEnvironment.NewLine);
			errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "IsDotNetException={0} ", _isDotNetException.ToString());
			errorBuilder.Append(PortableEnvironment.NewLine);
			errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "Message={0} ", _message);
			errorBuilder.Append(PortableEnvironment.NewLine);
			errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "DetailedDotNetException={0} ", (_detailedDotNetException != null) ? _detailedDotNetException.ToString() : "");
			errorBuilder.Append(PortableEnvironment.NewLine);
			errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "PubnubWebRequest={0} ", (_pubnubWebRequest != null) ? _pubnubWebRequest.ToString() : "");
			errorBuilder.Append(PortableEnvironment.NewLine);
			errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "PubnubWebResponse={0} ", (_pubnubWebResponse != null) ? _pubnubWebResponse.ToString() : "");
			errorBuilder.Append(PortableEnvironment.NewLine);
			errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "Channel={0} ", (_channel != null) ? _channel : "");
			errorBuilder.Append(PortableEnvironment.NewLine);
            errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "ChannelGroup={0} ", (_channelGroup != null) ? _channelGroup : "");
            errorBuilder.Append(PortableEnvironment.NewLine);
            errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "Description={0} ", _description);
			errorBuilder.Append(PortableEnvironment.NewLine);
			errorBuilder.AppendFormat(CultureInfo.InvariantCulture, "ErrorDateTimeGMT={0} ", _dateTimeGMT);
			errorBuilder.Append(PortableEnvironment.NewLine);
	...
	internal static class PubnubErrorCodeHelper
	{
		...
		public static PubnubErrorCode GetErrorType(int statusCode, string httpErrorCodeMessage)
		{
			...
			{
				case 400:
				if (httpErrorCodeMessage.ToUpper().IndexOf("MESSAGE TOO LARGE") >= 0)
				{
