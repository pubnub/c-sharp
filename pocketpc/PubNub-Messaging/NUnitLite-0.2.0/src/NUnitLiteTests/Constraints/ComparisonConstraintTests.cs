...
namespace NUnitLite.Tests
{
    ...
    {
        public GreaterThanTest(string name) : base(name) { }
    ...
    {
        public GreaterThanOrEqualTest(string name) : base(name) { }
    ...
    {
        public LessThanTest(string name) : base(name) { }
    ...
    {
        public LessThanOrEqualTest(string name) : base(name) { }
