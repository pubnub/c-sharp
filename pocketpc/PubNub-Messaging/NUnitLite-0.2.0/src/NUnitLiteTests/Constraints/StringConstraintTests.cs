...
namespace NUnitLite.Tests
{
    ...
    {
        public SubstringTest(string name) : base(name) { }
    ...
    {
        public SubstringTestIgnoringCase(string name) : base(name) { }
    ...
    {
        public StartsWithTest(string name) : base(name) { }
    ...
    {
        public StartsWithTestIgnoringCase(string name) : base(name) { }
    ...
    {
        public EndsWithTest(string name) : base(name) { }
    ...
    {
        public EndsWithTestIgnoringCase(string name) : base(name) { }
    ...
    {
        public EqualIgnoringCaseTest(string name) : base(name) { }
