...
namespace PubNubMessaging.Core
{
	public class Pubnub
	{
		...
		{
			return pubnub.Publish(channel, message, true, -1, "", userCallback, errorCallback);
		}

		public bool Publish<T>(string channel, object message, Action<T> userCallback, Action<PubnubClientError> errorCallback)
		{
            return pubnub.Publish<T>(channel, message, true, -1, "", userCallback, errorCallback);
		}
        ...
        {
            return pubnub.Publish(channel, message, storeInHistory, -1, "", userCallback, errorCallback);
        }
        ...
        {
            return pubnub.Publish<T>(channel, message, storeInHistory, -1, "", userCallback, errorCallback);
        }
        ...
        {
            return pubnub.Publish(channel, message, storeInHistory, -1, jsonUserMetaData, userCallback, errorCallback);
        }
        ...
        {
            return pubnub.Publish<T>(channel, message, storeInHistory, -1, jsonUserMetaData, userCallback, errorCallback);
        }

		public bool Publish(string channel, object message, bool storeInHistory, int ttl, string jsonUserMetaData, Action<object> userCallback, Action<PubnubClientError> errorCallback)
		{
			return pubnub.Publish(channel, message, storeInHistory, ttl, jsonUserMetaData, userCallback, errorCallback);
		}
		...
		{
			return pubnub.Publish<T>(channel, message, storeInHistory, ttl, jsonUserMetaData, userCallback, errorCallback);
		}
        ...
        {
            return PubnubMonoLinux.TranslateDateTimeToPubnubUnixNanoSeconds(dotNetUTCDateTime);
        }

        public static DateTime TranslatePubnubUnixNanoSecondsToDateTime(long unixNanoSecondTime)
        {
            return PubnubMonoLinux.TranslatePubnubUnixNanoSecondsToDateTime(unixNanoSecondTime);
        }
		...
		{
			pubnub = new PubnubMonoLinux (publishKey, subscribeKey, secretKey);
		}

		public Pubnub(string publishKey, string subscribeKey)
		{
			pubnub = new PubnubMonoLinux (publishKey, subscribeKey);
		}
		#endregion
	}
}