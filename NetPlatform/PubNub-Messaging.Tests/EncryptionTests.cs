...
namespace PubNubMessaging.Tests
{
    ...
    public class EncryptionTests
    {
        ...
        public void TestYayDecryptionBasic()
        {
            ...
            string decryptedMessage = pc.Decrypt(message);
            //deserialize again
			int same = string.Compare ("yay!", decryptedMessage, StringComparison.OrdinalIgnoreCase);
        ...
        public void TestStuffcanDecryption()
        {
			...
			int same = string.Compare ("{\"this stuff\":{\"can get\":\"complicated!\"}}", decryptedMessage, StringComparison.OrdinalIgnoreCase);
			Assert.IsTrue(same == 0);
        ...
        public void TestHashDecryption()
        {
			...
			int same = string.Compare(expectedMessage, decryptedMessage, StringComparison.OrdinalIgnoreCase);
